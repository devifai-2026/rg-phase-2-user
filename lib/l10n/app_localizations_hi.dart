...
class L10nHi extends L10n {
  ...
  String joinRudragangaAsAnAstrologer(String appName) {
    return '$appName में ज्योतिषी के रूप में शामिल हों';
  }
  ...
  String rudragangaProvidesAstrologySpiritualAndWellness(String appName) {
    return '$appName व्यक्तिगत मार्गदर्शन और विकास के लिए ज्योतिष, आध्यात्मिकता और स्वास्थ्य संबंधी परामर्श प्रदान करता है।';
  }
  ...
  String byCreatingAnAccountOrUsing(String appName) {
    return 'एक खाता बनाकर या $appName मोबाइल एप्लिकेशन और संबंधित सेवाओं (';
  }
  ...
  String rudragangaConnectsYouWithVerifiedAstrologers(String appName) {
    return '$appName आपको ऑडियो कॉल, वीडियो कॉल आदि के माध्यम से परामर्श के लिए सत्यापित ज्योतिषियों से जोड़ता है।';
  }
  ...
  String astrologersAreIndependentPractitionersWhoAre(String appName) {
    return 'ज्योतिषी स्वतंत्र पेशेवर हैं जिनकी पहचान $appName द्वारा सत्यापित और अनुमोदित की गई है।';
  }
  ...
  String ofRudragangaWeAreNotResponsible(String appName) {
    return '$appName के। परामर्श के आधार पर आपके द्वारा लिए गए किसी भी निर्णय के लिए हम जिम्मेदार नहीं हैं।';
  }
  ...
  String rudragangaMakesNoGuaranteeAboutThe(String appName) {
    return '$appName किसी भी भविष्यवाणी या उपाय की सटीकता की कोई गारंटी नहीं देता है।';
  }

  @override
  String permittedByLawRudragangaSTotal(String appName) {
    return 'कानून द्वारा अनुमत होने पर, सेवाओं के आपके उपयोग से उत्पन्न होने वाली $appName की कुल देयता सीमित है।';
  }
  ...
  String whenRequiredByLawOrTo(String appName) {
    return 'जब कानून द्वारा आवश्यक हो, या उपयोगकर्ताओं और $appName के अधिकारों, सुरक्षा और संपत्ति की रक्षा के लिए।';
  }
  ...
  String s2026Rudraganga18ForGuidanceAnd(String appName) {
    return '© 2026 $appName · 18+ · मार्गदर्शन और कल्याण के लिए →\nपेशेवर सलाह का विकल्प नहीं।';
  }
  ...
  String thesePermissionsAreRequiredToUse(String appName) {
    return '$appName का उपयोग करने के लिए इन अनुमतियों की आवश्यकता है। इन्हें प्रदान करने के लिए किसी भी लंबित आइटम पर टैप करें।';
  }
  ...
  String rudragangaConnectsYouWithTrustedVedic(String appName) {
    return '$appName आपको करियर संबंधी मार्गदर्शन के लिए विश्वसनीय वैदिक ज्योतिषियों से जोड़ता है।';
  }
  ...
  String yourFeedbackHelpsRudragangaGrow(String appName) {
    return 'आपकी प्रतिक्रिया $appName को आगे बढ़ने में मदद करती है।';
  }
  ...
  @override
  String get runNumerology => 'अंक ज्योतिष चलाएं';

  @override
  String get numerologyIntro =>
      'अपने नाम और जन्म तिथि से अपने अंक और उनके अर्थ जानें।';
  ...
  @override
  String get partner1 => 'लड़की';

  @override
  String get partner2 => 'लड़का';

  @override
  String get checkCompatibility => 'अनुकूलता जांचें';

  @override
  String get checkManglik => 'मांगलिक दोष जांचें';

  @override
  String get matchingIntro =>
      'विवाह अनुकूलता जांचें — गुण मिलान, दोष और कुल स्कोर।';

  @override
  String get manglikIntro =>
      'जांचें कि मांगलिक (मंगल) दोष है या नहीं, और कितना।';

  @override
  String get fillBothPartners => 'दोनों साथियों का जन्म विवरण दर्ज करें।';
  ...
  @override
  String get somethingWentWrong => 'कुछ गड़बड़ हो गई। कृपया दोबारा कोशिश करें।';

  @override
  String get askYourQuestion => 'अपना सवाल पूछें…';

  @override
  String get aiGreetingTitle => 'नमस्ते 🙏';

  @override
  String get aiGreetingBody =>
      'अपने मन की बात बताइए, मैं आपकी जन्म कुंडली देखकर बताऊँगा।';

  @override
  String get aiPickLanguage => 'आप किस भाषा में बात करना चाहेंगे?';

  @override
  String get aiRemedy => 'उपाय';

  @override
  String get aiEnded => 'यह परामर्श समाप्त हो गया।';
  ...
  String aiEndedBilled(String minutes) {
    return 'परामर्श समाप्त। $minutes मिनट का शुल्क लगा।';
  }

  @override
  String aiBillingNote(String rate) {
    return 'पहला संदेश भेजने पर ₹$rate/मिनट शुल्क शुरू होगा, अभी नहीं।';
  }

  @override
  String get readingYourChart => 'आपकी कुंडली देख रहे हैं…';

  @override
  String get getMyReading => 'मेरी भविष्यवाणी देखें';

  @override
  String get suggestedRemedies => 'सुझाए गए उपाय';

  @override
  String get birthDetailsNeededBody =>
      'जन्म विवरण से कुंडली सही पढ़ी जा सकती है। हम एक ही बार पूछेंगे।';

  @override
  String birthDetailsNeededFor(String topic) {
    return '$topic के लिए जन्म विवरण';
  }

  @override
  String get addBirthTimeForSharper =>
      'जन्म का सही समय जोड़ने से यह भविष्यवाणी अधिक सटीक होगी।';

  @override
  String get noAiAstrologersYet => 'अभी कोई AI ज्योतिषी उपलब्ध नहीं है।';
  ...
  @override
  String get notKnown => 'पता नहीं';

  @override
  String get confirmBirthDetails => 'अपना जन्म विवरण जाँचें';

  @override
  String get confirmBirthDetailsBody =>
      'इन्हीं से आपकी कुंडली पढ़ी जाएगी। कुछ गलत हो तो बदल लें।';

  @override
  String get birthDetailsNeedTimeBody =>
      'इस भविष्यवाणी के लिए जन्म का सही समय आवश्यक है, क्योंकि इसी से लग्न और भाव तय होते हैं।';

  @override
  String get tobSharpensReading =>
      'इसके बिना भी आगे बढ़ सकते हैं, पर सही समय से भविष्यवाणी अधिक सटीक होगी।';

  @override
  String get kundliLife => 'जीवन';

  @override
  String get kundliFears => 'भय और चिंताएँ';
}
